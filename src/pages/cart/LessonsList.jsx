...
import { mockLessons } from "../../data/mockLessons"; // путь корректируем по проекту
...
// -----------------------------------------------------------
// Мок-данные для первого запуска (Обратите внимание на префиксы)
// -----------------------------------------------------------
        ...
        {lessonIds.map((lessonId, index) => {
          ...
          return (
            <div key={lessonId} className="relative">
              ...
              {/* Карточка урока */}
              <Link
                to={`/lessons-list/${languageId}/${lessonId}`}
